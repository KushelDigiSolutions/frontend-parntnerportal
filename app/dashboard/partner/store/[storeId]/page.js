...
export default function StoreDetailsPage() {
    ...
    const getStatusColor = useCallback((status) => {
        ...
        switch (statusLower) {
            case "paid": return "rgb(50 200 100)";
    ...
    return (
        <div className="affiliate-container">
            ...
            {viewPayment && (
                <div style={styles.modalOverlay}>
                    <div style={styles.modalCard}>
                        <IoClose style={styles.closeIconStyle} onClick={() => setViewPayment(null)} />
                        ...
                        >
                            <p><strong>ID:</strong> {viewPayment?.id || "-"}</p>
                            <p><strong>Amount:</strong> {viewPayment?.amount || 0}</p>
                            <p><strong>Commission:</strong> {Math.floor(viewPayment?.commission || 0)}%</p>
                            <p>
                            ...
                            <p><strong>Start Date:</strong> {formatDate(viewPayment?.created_at)}</p>
                            <p><strong>End Date:</strong> {formatDate(viewPayment?.end_date)}</p>
                        </div>
                    </div>
                </div>
            )}
            ...
            {editPayment && (
                <div style={styles.modalOverlay}>
                    <div style={styles.modalCard}>
                        <IoClose style={styles.closeIconStyle} onClick={() => setEditPayment(null)} />
                        ...
                        <input
                            ...
                            onChange={(e) => handleEditPaymentChange("amount", e.target?.value)}
                        />
                        ...
                        <input
                            ...
                            onChange={(e) => handleEditPaymentChange("commission", e.target?.value)}
                        />
                        ...
                        <input
                            ...
                            onChange={(e) => handleEditPaymentChange("start_date", e.target?.value)}
                        />
                        ...
                        <input
                            ...
                            onChange={(e) => handleEditPaymentChange("end_date", e.target?.value)}
                        />
                        ...
                        <select
                            ...
                            onChange={(e) => handleEditPaymentChange("status", e.target?.value)}
                        >
                ...
                <div style={styles.modalOverlay}>
                    <div style={styles.modalCard}>
                        ...
                        <div style={styles.buttonRow}>
                            <button style={styles.secondaryBtn} onClick={() => setDeleteConfirm(null)}>
                                Cancel
                            </button>
